<template>
    <div ref="leaflet" style="height: 500px;"></div>
</template>
...
<script>
    ...
    export default defineComponent({
        // Based on: https://github.com/arbakker/pdok-js-map-examples/blob/master/leaflet-geojson-wmts-epsg28992/index.js
        data() { 
            return {
                map: null,
            }
        ...
        methods: {
            ...
            drawPolygon() {
                // Convert Polygon from EPSG:28992 to EPSG:4326
                // L.marker([50.888172, 5.979499]).addTo(this.map);

                let polygon = [[51.31953667485477, 3.357237628715765], [51.31966144982756, 3.364406388383263], [51.315169346904945, 3.3646051376266963], [51.31504458798438, 3.3574370813728525], [ 51.31953667485477, 3.357237628715765]]
                L.polygon(polygon, {
                    color: 'red',
                }).addTo(this.map);

                // let polygon = L.polygon([[13500, 371600], [13600, 371600], [13600, 371500], [13500, 371500], [13500, 371600]], {
                //     color: 'red',
                // }).addTo(this.map);
            ...
            loadMap() {
                // Load Marker icons, otherwise it will not show.
                ...
                const brtRegular = this.getWMTSLayer('standaard');
                // const brtGrijs = this.getWMTSLayer('grijs');
                // const brtPastel = this.getWMTSLayer('pastel');
                // const brtWater = this.getWMTSLayer('water');
