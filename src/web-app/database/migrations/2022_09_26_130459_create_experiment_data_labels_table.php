...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('experiment_data_labels', function (Blueprint $table) {
            $table->id();
            $table->foreignId('experiment_data_id')->references('id')->on('experiment_data')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('experiment_data_labels');
    }
};
